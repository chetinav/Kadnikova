...
label1 = tkinter.Label(frame1,text="Клевер луговой",font=("Segoe Print",10),bg="khaki2",fg="#2c2e0c").pack()
...
canvas1.pack()
btn1 = tkinter.Button(frame1,text="Клевер",font=("Segoe Print",10),bg="khaki2",fg="#2c2e0c",height=2,width=15)
btn1.pack(expand=1)
